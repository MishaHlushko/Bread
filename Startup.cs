...
using Beads_Store.Data.Repository;
using Beads_Store.Data.Services;
using Beads_Store.Data.Models.UserAppDBContext;
using Microsoft.AspNetCore.Identity;

namespace Beads_Store
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IBeadsRepository, BeadsRepository>();
            services.AddScoped<IMICategoryRepository, MICategoryRepository>();
            services.AddScoped<ICartRepository, CartRepository>();
            services.AddScoped<IBeadsService, BeadsService>();
